...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapgoCapacitorSocialLogin", path: "../../../../../node_modules/.pnpm/@capgo+capacitor-social-login@8.5.11_@capacitor+core@8.3.2/node_modules/@capgo/capacitor-social-login"),
